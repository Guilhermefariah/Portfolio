        ...
        <header className="bg-black text-gray-200 p-4">
            <div className="flex justify-between items-center">
                <a href="https://github.com/Guilhermefariah" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-gray-200" viewBox="0 0 24 24" fill="currentColor">
            ...
            <nav className={`sm:flex flex-col sm:flex-row ${isOpen ? 'flex' : 'hidden'}`}>
