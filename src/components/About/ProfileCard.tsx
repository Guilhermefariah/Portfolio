...
const ProfileCard = () => {
    return (
        <div id="About" className="flex flex-col items-center py-28">
            <h1 className="text-4xl py-12 text-center font-serif text-gray-600 underline hover:animate-pulse">
                Contact
            </h1>
            <motion.div 
                whileHover={{ scale: 1.1 }} 
                className="flex flex-col items-center opacity-90 hover:opacity-100 max-w-xs sm:px-12 bg-gradient-to-r from-blue-200 via-green-200 to-blue-300 p-6 border-2 rounded-lg shadow-lg text-black mt-4"
            >
                <div className="relative w-32 h-32 rounded-full overflow-hidden">
                    <Image 
                        src="/img/Profile.jpg" 
                        alt="Guilherme Faria's profile" 
                        layout="fill" 
                        objectFit="cover" 
                    />
                </div>
                <div className="flex flex-col items-center space-y-4 text-center mt-4">
                    ...
                    <div className="flex space-x-4">
                        <a
                            ...
                            className="p-2 rounded-md hover:text-white transition-colors duration-200"
                        >
                            <svg viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 fill-current">
